            ...
            <div className="space-y-4">
                {
                    roles.map((r)=>(
                        ...
                        w-full rounded-xl border px-4 py-3 text-sm font-medium capitalize transition${role === r ? "border-[#E23744] bg-[#E23744] text-white" : "border-gray-300 text-gray-700 hover:bg-gray-50"}`}>
                            Continue as {r} 
                        </button>
                    ))
                }
