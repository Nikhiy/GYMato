...
const RestaurantCard =({id,image,name,distance,isOpen}:props) => {
  ...
  return <div className={`cursor-pointer overflow-hidden rounded-xl bg-white shadow-sm transition hover:shadow-md ${!isOpen ? "opacity-80":""}`} onClick={()=>navigate(`/restaurant/${id}`)}>
